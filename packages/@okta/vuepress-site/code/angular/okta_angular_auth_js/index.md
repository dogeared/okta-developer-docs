...
icon: code-angular
---
This guide will walk you through integrating authentication and authorization into an Angular application using the [Okta Auth SDK, v4.0.2](https://github.com/okta/okta-auth-js).
